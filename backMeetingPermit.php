<?php
include 'db/db.php';
$sql  = "SELECT * FROM `meeting` Where `status` = 0";
...
<script>
    // let meetingPermitBtn = document.querySelectorAll(".meetingPermitBtn");

    // meetingPermitBtn.forEach(function(element) {
    //     element.addEventListener("click", function(e) {
    //         e.preventDefault();
    //         $(document).ready(function() {
    //             $.ajax({
    //                 type: "POST",
    //                 url: "meetingCommonPermit.php?i=" + element.dataset.id,
