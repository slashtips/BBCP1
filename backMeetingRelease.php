<?php
include 'db/db.php';
$sql  = "SELECT * FROM `meeting` Where `status` = 1";
            ...
            <tbody>
                ...
                foreach ($res as $meeting) {
                    ...
                    echo "<td>" .
                        ...
                        "<a href='#' data-id='$meeting[id]' class='btn btn-outline-success me-2 meetingReleaseBtn'>發布</a>" .
                        "</td>";
                    echo "</tr>";
                }
                ?>
...
<script>
    let meetingReleaseBtn = document.querySelectorAll(".meetingReleaseBtn");
    meetingReleaseBtn.forEach(function(element) {
