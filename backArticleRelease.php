        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                foreach ($res as $article) {
                    ...
                    echo "<td>" .
                        "<a href='ArticleCommon.php?i=$article[id]' target='_blank'  class='btn btn-outline-primary me-2'>預覽</a>" .
                        "<a href='system/backArticleRelease.php?id=$article[id]' class='btn btn-outline-success me-2'>發布</a>" .
                        "</td>";
                    echo "</tr>";
                }
                ?>
