...
$folder = '../store/Medical/'; //上傳路徑
$target = $folder . $fullname; // 目標路徑
$path = 'store/Medical/' . $fullname;
if (!is_dir($folder)) {
    mkdir($folder);
    //若資料夾不存在就建立資料夾
}
...
echo "<script> alert('文章新增成功，請等候批准');window.location.href='../back_articleMedical.html'; </script>";
exit;
