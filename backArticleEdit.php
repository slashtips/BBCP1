...
$sql2 = "SELECT * FROM `article0` where `id` = '$_GET[id]' order by `id` DESC";
...
<body>
	...
	<div class="container text-center">
		<h1>編輯旅程文章</h1>
		<form action="system/backArticleEditSuccess0.php" method="post">
			<!-- 
			<div class="mb-3">
			...
			<div class="col-12 topicSec mb-3">
				<label for="topicSec" class="form-label">標籤</label>
				<select class="form-select" id="topicSec" name="topicSec" aria-label="Default select example">
			...
			<a class="btn btn-outline-secondary" href="backArticleEditInfo0.php">取消</a>
