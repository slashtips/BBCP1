        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                foreach ($res as $article) {
                    ...
                    echo "<td>" . $article['topicSec'] . "</td>";
                    echo "<td>" . $article['title'] . "</td>";
                    echo "<td>" . $article['source'] . "</td>";
                    echo "<td>" . $article['createTime'] . "</td>";
                    echo "<td>" . $article['updateTime'] . "</td>";
                    echo "<td>"
                        . "<a href='backArticleIndexArticleEdit.php?id=$article[id]' class='btn btn-outline-success me-2'>編輯</a>"
                        . "<button type='button' data-id='" . $article['id'] . "' class='btn btn-outline-danger btnDeleteCheck' data-bs-toggle='modal' data-bs-target='#exampleModal'>刪除</button>"
                        . "</td>";
                    echo "</tr>";
                }
                ?>
...
<script>
    ...
    function myexcel1() {
        ...
        var table_div = document.querySelector('.table').innerHTML + '';
        a.href = data_type + ', ' + encodeURIComponent(html + table_div);
