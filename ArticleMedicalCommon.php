...
include 'db/db.php';
$id = $_GET['i'];
$sql = "SELECT * FROM `articleM` WHERE `id` = $id";
$res = mysqli_query($connect, $sql);
$row = mysqli_fetch_array($res);

$topicSec = $row['topicSec'];
$sqlR = "SELECT * FROM `articleM` WHERE `id` <> $id AND `topicSec` = '$topicSec' AND `publish` = 1 ORDER BY id DESC LIMIT 0 , 3 ";
...
$sqlC = "SELECT * FROM `articleM` WHERE `id` <> $id  AND `publish` = 1 ORDER BY id DESC LIMIT 0 , 5 ";
...
<head>
    ...
    <title>醫護文章-<?php echo $row['title']; ?></title>
    ...
    <div class="wrap">
        ...
        <div class="article">
            ...
            <div class="content">
                ...
                <div class="back3">
                    <a href="MedicalArea.php"><img src="pic/Common/back.svg" alt=""></a>
